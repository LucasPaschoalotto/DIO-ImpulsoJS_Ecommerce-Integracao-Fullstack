...
const Contatos = () => {
    ...
    return(
        <>
            ...
            <Button onClick={sendMsg} className="mt-2" variant="contained" color="primary">
                Sent
            </Button>
            ...
            {message.map((content) => {
                return(
                    <div className="card mt-2" key={content.id}>
                        <div class="card-body">
                            <h5 class="card-title">{content.email}</h5>
                            <p class="card-text">{content.message}</p>
                            <p class="card-text"><small class="text-muted">{content.created_at}</small></p>
                        </div>
                    </div>
                )
            })
